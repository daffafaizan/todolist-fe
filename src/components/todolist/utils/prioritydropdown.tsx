  ...
  return (
    <>
      <Menu as="div" className="relative flex flex-col items-center text-left">
        <Menu.Button
          className={`text-gray-500 cursor-pointer hover:scale-125 duration-300 ml-8 ${
            priority === "High"
              ? "text-red-500"
              : priority === "Medium"
                ? "text-yellow-500"
...
function HighInactiveIcon(props: any) {
  return (
    <svg
      {...props}
      viewBox="0 0 448 512"
...
function HighActiveIcon(props: any) {
  return (
    <svg
      {...props}
      viewBox="0 0 448 512"
...
function MediumInactiveIcon(props: any) {
  return (
    <svg
      {...props}
      viewBox="0 0 448 512"
...
function MediumActiveIcon(props: any) {
  return (
    <svg
      {...props}
      viewBox="0 0 448 512"
...
function LowInactiveIcon(props: any) {
  return (
    <svg
      {...props}
      viewBox="0 0 448 512"
...
function LowActiveIcon(props: any) {
  return (
    <svg
      {...props}
      viewBox="0 0 448 512"
